...
function Navbar() {
    return (
        <>
            <div className='lg:w-1/2 md:w-3/4 sm:w-3/4 m-auto py-3 bg-white dark:bg-gray-900'>
                    ...
                    <div class="container flex flex-wrap items-center justify-between mx-auto">
                        ...
                        <div class="font-inter hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                            <ul class="flex flex-col mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                                <li>
                                    <Link to="/" class="block py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-white md:dark:bg-transparent">Home</Link>
                                </li>
                                <li>
                                    <Link to="/firstmenu" class="block py-2 pl-3 pr-4 text-white rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-white md:dark:bg-transparent">Contact Table</Link>
                                </li>
                                <li>
                                    <Link to="/secondmenu" class="block py-2 pl-3 pr-4 text-white  rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-white md:dark:bg-transparent">OTP History</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
